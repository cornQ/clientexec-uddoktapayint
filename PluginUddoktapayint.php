...
class PluginUddoktaPayInt extends GatewayPlugin
{
    ...
    {
        $apiKey = $params['plugin_uddoktapayint_API KEY'];
        $apiBaseURL = $params['plugin_uddoktapayint_API URL'];
        $uddoktaPay = new UddoktaPayInt($apiKey, $apiBaseURL);

        $baseURL = rtrim(CE_Lib::getSoftwareURL(), '/') . '/';
        $callbackURL = $baseURL . "plugins/gateways/uddoktapayint/callback.php";
