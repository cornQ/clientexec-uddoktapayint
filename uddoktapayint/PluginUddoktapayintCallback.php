...
require_once 'plugins/gateways/uddoktapayint/UddoktaPayInt.php';

class PluginUddoktaPayIntCallback extends PluginCallback
{
    public function processCallback()
    {
        $cPlugin = new Plugin('', 'uddoktapayint', $this->user);
        $apiKey = trim($cPlugin->GetPluginVariable("plugin_uddoktapayint_API KEY"));
        $apiBaseURL = trim($cPlugin->GetPluginVariable("plugin_uddoktapayintl_API URL"));
        ...
        $cPlugin = new Plugin($invoiceId, 'uddoktapayint', $this->user);
